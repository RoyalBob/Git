...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <article class="index" runat="server" style="margin:0">
        <div class="wrapper" Runat="Server">
            <asp:GridView ID="GridView3" CssClass="gridview" runat="server" AutoGenerateColumns="False" DataKeyNames="fileid" GridLines="None" ShowHeader="False" AllowPaging="True" AllowSorting="True" DataSourceID="SqlDataSource4" PageSize="3">
                    <Columns>
                        <asp:TemplateField SortExpression="publishdate" HeaderText="新闻标题">
                            <ItemTemplate>
                                <asp:HyperLink CssClass="item" ID="HyperLink" runat="server" Text='<%# "<h2>["+Eval("type", "{0}")+"]  "+Eval("filename", "{0}")+"</h2><h5>发表于 "+Eval("publishdate", "{0:d}")+"</h5>" %>' BorderStyle="None" NavigateUrl='<%# "content.aspx?id="+Eval("fileid") %>'></asp:HyperLink>
                                <br />
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:newsConnectionString %>" SelectCommand="SELECT * FROM files where publishdate=@publishdate" ProviderName="<%$ ConnectionStrings:newsConnectionString.ProviderName %>">
                    <SelectParameters>
