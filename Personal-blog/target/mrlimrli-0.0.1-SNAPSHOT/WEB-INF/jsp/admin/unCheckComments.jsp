  ...
  <section>
    ...
    <div class="mainpanel">
      ...
      <div class="pageheader">
        <h2><i class="fa fa-comment-o"></i>评论<span>文章评论</span></h2>
        <div class="breadcrumb-wrapper">
          <span class="label">导航:</span>
          <ol class="breadcrumb">
            <li>后台</li>
            <li><a href="javascript:history.go(-1);">上一级</a></li>
            <li class="active">文章评论</li>
          </ol>
        </div>
      </div>
              ...
              <div class="panel-body">
                <div class="pull-right">
                  ...
                  <div class="btn-group mr10">
                    ...
                    <ul class="commentsType dropdown-menu">
                  ...
                  <div class="btn-group">
                    ...
                    <c:if test="${pageNum == 1 }">
                      <button id="unCheckCommentPre" class="btn btn-sm btn-white disabled" type="button"><i class="glyphicon glyphicon-chevron-left"></i></button>
                    </c:if>
                    <c:if test="${pageNum != 1 }">
                      <button id="unCheckCommentPre" class="btn btn-sm btn-white" type="button"><i class="glyphicon glyphicon-chevron-left"></i></button>
                    </c:if>
                    <c:if test="${pageNum == pageCount }">
                      <button id="unCheckCommentNext" class="btn btn-sm btn-white disabled" type="button"><i class="glyphicon glyphicon-chevron-right"></i></button>
                    </c:if>
                    <c:if test="${pageNum != pageCount }">
                      <button id="unCheckCommentNext" class="btn btn-sm btn-white" type="button"><i class="glyphicon glyphicon-chevron-right"></i></button>
                    </c:if>
                  </div>
                </div><!-- pull-right -->
                <h5 class="subtitle mb5">未审核评论</h5>
                      ...
                      <tr class="unread">
                        <td>
                          <div class="ckbox ckbox-success">
                            <input type="checkbox" name="checkbox" id="checkbox${comment.id }" value="${comment.id }">
                            <label for="checkbox${comment.id }"></label>
                          </div>
                        </td>
                        <td>
                        </td>
                        <td onclick="readArticle(${comment.article_id});">
                          <div class="media">
                            <div class="media-body">
                              <span class="media-meta pull-right"><fmt:formatDate value="${comment.createtime }" pattern="yyyy-MM-dd HH:mm" /></span>
                              <h4 class="text-primary">${comment.article_title }</h4>
                              <small class="text-muted"></small>
                              <p class="email-summary"><strong>${comment.nickname }：</strong> ${comment.comment }</p>
                            </div>
                          </div>
                        </td>
                      </tr>
